...
<div class="bred_outer">
    <div class="bred_nav">
        <ul>
            ...
            <li><a href="<?php echo base_url();?>admin/email_template/" style="color: #1a91ec;">CMS Pages</a></li>
            <li><img class="bn_arow" src="<?php echo base_url();?>public/images/br_arow.jpg"></li>
            <li>Details</li>
        </ul>
    </div>
...
<div class="container">   
    <div class="topsec">
        ...
        <a class="back_btn_org" href="<?php echo base_url(); ?>admin/cms/">Back</a>
    </div>
    <div class="wd_975">
                        ...
                        <tr>
                            ...
                            <td class="td_wht">
                                        <div class="div_details_in_r" style="margin-top:5px;">
                                            <input type="hidden" value="<?php echo htmlentities($cms['title']) ;?>" name="email_title" id="email_title"/>
                                            <?php if($cms['title']) : echo htmlentities($cms['title']); else : echo $_POST['title'] ; endif; ?>
                                        </div>
                            </td>       
                        </tr>
                       <!-- <tr>
                        ...
                        <td class="td_wht">
                            <div class="div_details_in_r" >
                                <textarea name="email_template" id="email_template" cols="20" rows="35" class="ckeditor" style="width:500px;">
                                    <?php if($cms['description']) : echo $cms['description']; else : echo $_POST['description'] ; endif;?>
                                </textarea>
