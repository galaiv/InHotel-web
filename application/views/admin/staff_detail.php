...
<div class="wd_975">
<div class="wd_975_title"><h3> HOTEL STAFF DETAILS</h3></div>
...
<div class="wd_935 mrb_10">   
    ...
    <div class="form_adj_up" ><label>Gender<font color="#FF0000">*</font></label>
        <select name="gender" id="gender"  class="form_med" style="width:460px;">
    ...
    <div class="wd_935 mrb_10">   
     <div class="form_adj_up" ><label>Hotel</label>
                            <select name="hotel_id" class="form_med required" style="width:460px;" >
                                <?php foreach ($hotel_list as $hotel) { ?>
                                    <option <?php echo ($member_details['staff_hotel_id'] == $hotel['id']) ? 'selected' :''; ?> value="<?php echo $hotel['id']; ?>"><?php echo $hotel['title']; ?></option>  
                                <?php } ?></select>
                        </div>
    </div>
