...
<div class="wd_935 mrb_10">   
    ...
    <div class="form_adj_up" ><label>Gender<font color="#FF0000">*</font></label>
     ...
     <input type="text" placeholder="Birth Date" name="dob" id="dob" value="<?php echo ($_POST['dob']) ? $_POST['dob'] :  $access_details['dob']?>" class="form_med" style="width:442px;" />
    </div>
</div>
  
<div class="wd_935 mrb_10">   
    <div class="form_adj_up" ><label>Access Start Date<font color="#FF0000"></font></label>
     <input type="text" placeholder="Access Start Date" name="access_start_date" id="access_start_date" value="<?php echo ($_POST['access_start_date']) ? $_POST['access_start_date'] :  $access_details['access_start_date_time']?>" class="form_med" style="width:442px;" />
    </div>
 <div class="form_adj_rte" ><label>Access End Date<font color="#FF0000"></font></label>
     <input type="text" placeholder="Access End Date" name="access_end_date" id="access_end_date" value="<?php echo ($_POST['access_end_date']) ? $_POST['access_end_date'] :  $access_details['access_end_date_time']?>" class="form_med" style="width:442px;" />
    </div>
  <div class="wd_935 mrb_10">   
    <div class="form_adj_up" ><label>Hotel<font color="#FF0000">*</font></label>
 ...
 <div class="form_adj_rte" ><label>Room Number<font color="#FF0000"></font></label>
