                    ...
                    foreach ($cms as $row => $val) {  ++$i; ?>   
                        <tr>
                            ...
                            <td class="td_wht txt_blue" align="left" >
                                <a class="txt_blue" style="text-decoration: none;"
                                 href="<?php echo base_url(); ?>admin/cms/edit_cms/<?php echo $val['id']; ?>" class="link1"><?php echo $val['title']; ?></a>
                            </td>
