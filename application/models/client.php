 ...
 //echo "hi";exit;
    ...
    function MessageDetails($arr) {  //print_r($arr);
        $this->load->model('client_model');
		 ...
		 $message_info['to_image'] = ($user_details['to_image'] != "") ? base_url() . 'upload/member/thumb/' . $user_img[0] . '_thumb.' . $user_img[1] : base_url() . 'upload/noimg_chat.png';
		  $message_info['from_user'] = $arr['from_id'];
		 $message_info['from_name'] = $user_details1['first_name'].''.$user_details1['last_name'];
		 $message_info['from_image'] = ($user_details1['to_image'] != "") ? base_url() . 'upload/member/thumb/' . $user_img[0] . '_thumb.' . $user_img[1] : base_url() . 'upload/noimg_chat.png';
