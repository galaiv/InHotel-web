...
class order_model extends CI_Model {
 ...
 $this->db->select('hp.title as hotel_title,dm.title as drink_title,om.*,imm.first_name as offered_first_name,imm.last_name as offered_last_name,imm1.first_name as recipient_first_name,imm1.last_name as recipient_last_name')
    ...
    public function getAllOrder($num = '0', $offset = '0') {
        if (trim($offset) == '')
            $offset = '0';
        $hotel_id = $this->db->escape_str($_REQUEST['hotel']);
        $from_date = $this->db->escape_str($_REQUEST['from_date']);
