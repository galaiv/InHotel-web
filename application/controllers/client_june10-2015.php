...
//                                echo $this->config->item('absolute_url');
	...
	function send_push_message() {
		...
		//echo $message;exit;
		$this->client_model->sendPushNotification($message,$device_tocken,$badge_count,$_POST['userid'],$from_details['quickblox_id']);
	}
    ...
    function sendPushNotification1($message, $devicetocken, $badge_count = 1) {
	  ...
	  $deviceToken ="4baa1f857d9f864c26bd9a9a124b97f242af433e9f9cc261696aecd360f8c132";
