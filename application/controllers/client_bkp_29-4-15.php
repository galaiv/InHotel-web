...
class Client extends CI_Controller {
    ...
    public function index() {
        ...
        // $json = '{"function":"checkActivationCodeExpires", "parameters": {"activation_code":"1224329184","user_id":"5"},"token":""}';
        //$json = '{"function":"GetAllGuestUsers", "parameters": {"activation_code":"1380479981","page":"0","user_id":"4"},"token":""}';
        //  
        ...
        //$json ='{"function":"updateDrinksStatus","parameters":{"status_flag":"A","drink_id":"6"}}';
    ...
    function login() {
        /*    $_POST = array(
          "username" => "haripriya@newagesmb.com",
          "password" => "123456",
          "member_type" => "1",
          "device_token" => "",
...
//echo json_encode($_FILES);exit;
        ...
        //$_POST['email_address'] = "haripriya@newagesmb.com";
    ...
    public function GetAllGuestUsers($arr) {
        ...
        for ($i = 0; $i < count($result); $i++) {
            ...
            $result[$i]['image'] = ($result[$i]['image'] != "") ? base_url() . 'upload/member/thumb/' . $result[$i]['image'] : base_url() . 'upload/noimg_account.png';
        }
    ...
    function get_user_details($arr) {
        $details = $this->client_model->get_user_details($arr['user_id']);
