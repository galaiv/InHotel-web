                ...
                if ($user_id != "" && $user_id != "0") {   
                    ...
                    if ($member_type == 2) { //hotel owner
                        ...
                        $this->member_model->save_zone($hotel_id);
							 $array12=array();
					    $array12['user_id'] = $user_id;
					    $array12['expiry_date'] = date('Y-m-d', strtotime("+ 2 month")); //print_r($array12);exit;
					     $this->member_model->updateMembershipRenewDetailsSignup($array12);
