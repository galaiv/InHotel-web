...
.blurbox-noscroll {  height: 100%; width: 100%; }\
.blurbox-hidden { display: none !important; }\
#blurbox-wrapper { overflow: auto; padding: 10px; -moz-box-sizing:none; border-radius: 5px; background-color: white; opacity: 0; position: fixed; top: 50%; left: 50%; z-index: 9999; width: 50%; height: 50%; max-width: 95%; max-height: 95%; display: block; }\
...
@media (max-width: 480px) {\
	...
	#blurbox-wrapper.blurbox-show { top: -50; }\
}\
',
